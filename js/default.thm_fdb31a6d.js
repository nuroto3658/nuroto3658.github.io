window.skins=window.skins||{};
	...
	function GameViewSkin() {
		_super.call(this);
		this.skinParts = ["BGImg","masterGP","enemyGP","battlGP","vsImg","masterImg","enemyImg","figureGP","questionImg","answerImg","nextImg","countdownFNT","questionGP","mapBGImg","optionGP_1","buttonGP_1"];
	...
	_proto.questionGP_i = function () {
		...
		t.horizontalCenter = 0;
		t.verticalCenter = 0;
		t.elementsContent = [this.questionImg_i(),this.answerImg_i(),this.nextImg_i(),this.countdownFNT_i()];
		return t;
	};
